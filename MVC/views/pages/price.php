...
<div class="row contacts">
  <div class="span2"><h3>Start 100%</h3><h4>Стартовый тариф</h4></div>
  <div class="span3"><h3>Standart 103.5%</h3><h4><i class="icon-24-Favorite icon-white"></i> +3.5% к Start</h4><h4><i class="icon-24-Paste icon-white"></i> > 50 000 руб. в неделю</h4></div>
  <div class="span3"><h3>Premium 106%</h3><h4><i class="icon-24-Favorite icon-white"></i> +6% к Start</h4><h4><i class="icon-24-Paste icon-white"></i> > 100 000 руб. в неделю</h4></div>
</div>
    </div>
	</div>
    <br>
  ...
  <thead><tr><th>Короткий номер</th><th>Цена для абонента</th></tr></thead>
            <tbody id="numbersTBody"></tbody>
</table>

        </div>
        <div class="span9">
        <h2>Расценки для основных операторов на номер <span id="numberSpan">3252</span></h2>
