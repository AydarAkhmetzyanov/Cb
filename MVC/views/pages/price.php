<div class="container">
  ...
  <thead><tr><th>Короткий номер</th><th>Цена для абонента</th><th>Предпрефикс</th></tr></thead>
        ...
        <h1>Расценки для основных операторов</h1>
            ...
            <p>Цены для абонента указаны без НДС.</p>

<p>В разных странах процентная ставка НДС (и стоимость для абонента) может <a href="http://a1pay.ru/main/nds">варьироваться</a>.</p>
